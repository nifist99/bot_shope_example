...
class SplashScreen:
    ...
    def aturWindow(self):
        ...
        Label(self.parent,  text="Tanlalana Bot Shopee v1",bg="#3DB2FF",fg="black", font=("Helvetica", 14), width=9, height=2).pack(side=TOP,anchor=N,fill=X)
        s = ttk.Style()
        s.theme_use('alt')
        s.configure("red.Horizontal.TProgressbar", background='#FFB830', foreground="white", relief=FLAT,bd=0,height=2)
